...
export default function ProjectPage({
  ...
  return (
    <main>
      ...
      <section className="mx-5 py-8 mt-5 md:mx-55 md:mt-15">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center border-b border-gray-300 pb-10 md:pb-20">
